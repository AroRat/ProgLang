...
**Третий и четвёртый варианты также неверны**, поскольку первая по очереди `*/` закрывает комментарий, а вторая выходит наружу. Если её не убрать, на выходе получится `Invalid syntax`.
